...
// Function for "REWARDS" button
function Reward() {
    window.location.href = "rewards.html"; // Replace with the actual URL or path of the Rewards page
}

// Function for "TASKS" button
function viewTasks() {
    window.location.href = "tasks.html"; // Replace with the actual URL or path of the Tasks page
}

// Function for "FRIENDS" button
function viewFriends() {
    window.location.href = "friends.html"; // Replace with the actual URL or path of the Friends page
}

// Function for "WALLET" button
function viewWallet() {
    window.location.href = "wallet.html"; // Replace with the actual URL or path of the Wallet page
}

// Function for "MUSIC" button
function viewMusic() {
    window.location.href = "music.html"; // Replace with the actual URL or path of the Music page
}
